import { fetchNotificationData } from "@/database/data";
import Link from "next/link";

export default async function Notification() {
  //ejecutar la funcion de las notificaciones todas la referentes son varias tablas,

  const {cantEstudiantes, cantMentores, cantEquipos} = await fetchNotificationData();
