...
export default async function Table({
    ...
    const grupos = await fetchFilteredEstudiantes(query, currentPage);
                            ...
                            >
                                ...
                                <div className="flex w-full items-center justify-between pt-4">
                                    ...
                                    <div className="flex justify-end gap-2">
                                        <ViewButton url={`/edit/estudiante/${grupo.id.toString()}`} />
                                        <EditButton url={`/edit/estudiante/${grupo.id.toString()}`} />
                                        <DeleteButton url={`/api/estudiante/${grupo.id.toString()}`} />
                                    </div>
                                </div>
                            </div>
                        ))}
                                ...
                                >
                                    ...
                                    <td className="whitespace-nowrap py-3 pl-6 pr-3">
                                        <div className="flex  justify-end gap-3">
                                            ...
                                            <EditButton url={`/edit/grupo/${grupo.id.toString()}`} />
