    ...
    return (<> 
        <section className="container max-w-5xl p-5 lg:pt-20 ml-14 lg:ml-0">
            <div className="bg-white dark:bg-gray-700 rounded-xl shadow-xl p-5">
                <h1 className="text-lg lg:text-4xl text-center font-bold m-5" >Card del Estudiante {estudiante.nombre} {estudiante.apellido}</h1>       
                <div className="w-full max-h-124 flex-col p-1 lg:p-12">
                    <hr />
                {<div className="grid grid-cols-1 justify-center  items-center lg:grid-cols-2  mt-5">
