    ...
    return (
        <>
            <section className="container max-w-5xl">
                ...
                <div className="border-2 border-gray-200 rounded-xl shadow-lg p-4">         
                <div className="w-full mb-5 max-h-36 flex-col p-1  md:p-2 text-black border-2 border-gray-200 bg-white rounded-lg shadow-lg">
                {   
            ...
            <div className="w-full mb-5 border-2 border-gray-200 flex-col p-1 md:p-2 bg-white rounded-lg text-black shadow-lg">
                <h2 className="text-center font-bold p-4 underline text-xl">Mentores</h2>
            {
                ...
                <div className="w-full  max-h-124 flex-col p-1  md:p-2 text-black border-2 border-gray-200 shadow-lg bg-white rounded-lg ">
                <h2 className="text-center font-bold p-4 underline text-xl">Integrantes</h2>
                    {
