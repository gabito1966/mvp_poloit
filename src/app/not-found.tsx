...
export default function NotFound() {
  return (
    <main className=" m-auto lg:mt-40 p-6 bg-gray-100 rounded-xl shadow-md shadow-blue-50">
      <div className='flex h-full flex-col items-center justify-center gap-2 p-3 bg-white rounded-xl'>
